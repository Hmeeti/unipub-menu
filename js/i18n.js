...
(function (global) {
  ...
  var UI = {
    ru: {
      ...
      basketSend: "Оформить заказ",
      basketChooseWaiter: "Выбрать официанта",
      basketWaitersTitle: "Кто ваш официант?",
      basketEmpty: "Корзина пуста",
      splitOn: "Разделить счёт",
      splitOff: "Скрыть разделение",
      splitAdd: "+ Человек",
      splitWho: "Кто",
      splitShared: "Общее",
      splitByPerson: "По людям",
      splitMe: "Я",
      splitFriend: "Друг",
      splitGuest: "Гость",
      splitRename: "Имя",
      splitMaxPeople: "Максимум 8 человек",
      openMaps: "Карта",
      phone: "Позвонить",
      wa: "WhatsApp",
      ig: "Instagram",
    ...
    kz: {
      ...
      basketTotal: "Жиыны",
      basketClear: "Тазалау",
      basketSend: "Тапсырыс беру",
      basketChooseWaiter: "Даяшыны таңдау",
      basketWaitersTitle: "Даяшыңыз кім?",
      basketEmpty: "Себет бос",
      splitOn: "Шотты бөлу",
      splitOff: "Бөлуді жасыру",
      splitAdd: "+ Адам",
      splitWho: "Кім",
      splitShared: "Ортақ",
      splitByPerson: "Адамдар бойынша",
      splitMe: "Мен",
      splitFriend: "Дос",
      splitGuest: "Қонақ",
      splitRename: "Аты",
      splitMaxPeople: "Ең көбі 8 адам",
      openMaps: "Карта",
      phone: "Қоңырау",
      wa: "WhatsApp",
      ig: "Instagram",
    ...
    en: {
      ...
      basketTotal: "Total",
      basketClear: "Clear",
      basketSend: "Place order",
      basketChooseWaiter: "Choose waiter",
      basketWaitersTitle: "Who is your waiter?",
      basketEmpty: "Cart is empty",
      splitOn: "Split the bill",
      splitOff: "Hide split",
      splitAdd: "+ Person",
      splitWho: "Who",
      splitShared: "Shared",
      splitByPerson: "Per person",
      splitMe: "Me",
      splitFriend: "Friend",
      splitGuest: "Guest",
      splitRename: "Name",
      splitMaxPeople: "Max 8 people",
      openMaps: "Map",
      phone: "Call",
      wa: "WhatsApp",
      ig: "Instagram",
